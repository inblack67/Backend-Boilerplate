      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            salt = _context.sent;
            _context.next = 6;
            return (0, _bcryptjs.hash)(this.password, salt);
...
UserSchema.methods.matchPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(enteredPassword) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _bcryptjs.compare)(enteredPassword, this.password);
